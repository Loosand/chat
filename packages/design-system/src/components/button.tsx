/**
 * [INPUT]: Base UI Button primitive、CVA variants 与 cn 类名合并工具
 * [OUTPUT]: shadcn/ui Base UI Button 和 buttonVariants
 * [POS]: @repo/design-system 首个 shadcn/ui primitive，由仓库直接拥有源码
 *
 * [PROTOCOL]:
 * 1. Button props、variants 或交互语义变化时更新此 Header。
