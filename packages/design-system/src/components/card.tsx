/**
 * [INPUT]: React card content、size 与共享 cn
 * [OUTPUT]: shadcn/ui Base Rhea Card 组合 primitive
 * [POS]: @repo/design-system 的分组表面容器
 *
 * [PROTOCOL]: size、slot 或表面语义变化时同步本目录 .folder.md 和调用方。
 */
