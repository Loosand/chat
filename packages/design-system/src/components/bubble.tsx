/**
 * [INPUT]: Base UI render helper、CVA variants 与消息气泡内容
 * [OUTPUT]: Bubble、BubbleContent、BubbleGroup 与 reaction 容器 primitive
 * [POS]: @repo/design-system 的消息表面基础，不解释消息领域状态
 *
 * [PROTOCOL]:
 * 1. 气泡 variant、对齐或可访问交互变化时更新此 Header。
 * 2. 消息角色和业务动作由调用方决定。
 */
