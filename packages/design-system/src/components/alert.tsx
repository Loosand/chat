/**
 * [INPUT]: React alert content、CVA variants 与共享 cn
 * [OUTPUT]: shadcn/ui Base Rhea Alert 组合 primitive
 * [POS]: @repo/design-system 的可访问状态/错误提示容器
 *
 * [PROTOCOL]: variant、slot 或语义变化时同步本目录 .folder.md 和调用方。
 */
