/**
 * [INPUT]: Base UI render helper、CVA variants 与会话标记内容
 * [OUTPUT]: 默认、分隔线和边框样式的 Marker primitive
 * [POS]: @repo/design-system 的系统提示、日期和流状态标记基础
 *
 * [PROTOCOL]:
 * 1. Marker variant、图标或内容 contract 变化时更新此 Header。
 * 2. 不在此定义聊天状态机或业务文案。
 */
