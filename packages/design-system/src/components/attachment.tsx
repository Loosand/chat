/**
 * [INPUT]: Base UI render helper、Button、CVA variants 与附件展示内容
 * [OUTPUT]: 可组合的 Attachment、媒体、状态、操作和横向附件组 primitive
 * [POS]: @repo/design-system 的无业务附件外观与交互基础
 *
 * [PROTOCOL]:
 * 1. 附件状态、布局、操作或公开 props 变化时更新此 Header。
 * 2. 业务文件权限、上传和预览状态不得在本文件实现。
 */
