/**
 * [INPUT]: React 消息行内容、对齐、头像、头部与尾部信息
 * [OUTPUT]: 无状态 Message 布局 primitive
 * [POS]: @repo/design-system 的会话行结构，不解析 UIMessage parts
 *
 * [PROTOCOL]:
 * 1. Message 布局 slot、对齐或公开 props 变化时更新此 Header。
 * 2. 消息 parts、工具与持久化规则由聊天 feature 实现。
 */
